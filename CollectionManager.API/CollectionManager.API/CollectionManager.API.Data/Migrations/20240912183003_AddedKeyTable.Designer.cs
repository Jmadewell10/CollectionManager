...
namespace CollectionManager.API.Data.Migrations
{
    ...
    [Migration("20240912183003_AddedKeyTable")]
    partial class AddedKeyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectionManager.API.Domain.Key", b =>
                {
                    b.Property<Guid>("KeyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CollectionManager.API.Domain.Key", b =>
                {
                    b.HasOne("CollectionManager.API.Domain.Account", "Account")
                        .WithOne("Key")
                        .HasForeignKey("CollectionManager.API.Domain.Key", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
